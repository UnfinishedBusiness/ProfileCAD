...
function initProfileRenderCore (context) {
  ...
  var ProfileRender = context.ProfileRender = function (opt_config) {
    ...
    this._crosshairMeta = {color: "red", selected: false, selected_timestamp: null, style: "solid", mouse_over: false, snap_points: [], on_mouse_motion: null, on_mouse_click: null};
   ...
   */
    ...
    /**
    * Cancel all entiites that have an active motion or click callback
    **/
