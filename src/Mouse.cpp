...
void mouseClick(int btn, int state, float x, float y)
{
    ...
    if(btn==MOUSE_RIGHT_BUTTON && state==MOUSE_DOWN)
    {
...
void mousePassiveMotionCallback(float x, float y)
{
  point_t pos = point_t{x, y};
  mouseCurrent = pos;
